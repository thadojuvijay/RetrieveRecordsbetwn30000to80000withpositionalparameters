...
Query query = session.createQuery("from com.ecil.Employee where employeeSalary >=:min and employeeSalary<=:max");

query.setParameter("min", 30000d);
query.setParameter("max",80000d);
